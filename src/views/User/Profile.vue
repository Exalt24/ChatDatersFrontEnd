      ...
      <div v-if="user" :id="`user-${user.id}`">
        ...
        <div>
          <div class="rounded-md p-3 bg-gray-200">
            ...
            <div>
              <strong class="block text-center" :style="{ fontSize: '40px' }">{{ user.firstName }} {{ user.lastName }}</strong>
            </div>
        </div>
          </div>
        </div>
        ...
        <div class="rounded-lg p-3 bg-gray-200">
          <strong class="block" :style="{ fontSize: '30px' }">Details:</strong>
          <div class="my-5">
            <table class="min-w-full bg-white divide-y divide-gray-300">
              <tbody class="bg-white divide-y divide-gray-200">
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900">Location:</td>
                  <td class="px-6 py-4 whitespace-nowrap">{{ user.locationCountry }}, {{ user.locationRegion }}, {{ user.locationCity }}</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900">Bio:</td>
                  <td class="px-6 py-4 whitespace-nowrap">{{ user.bio }}</td>
                </tr>
                <tr>
